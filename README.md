...
Funcionalidades
Total de resultados posibles - Calcula el tamaño del espacio muestral
Ambos muestran el mismo número - Cuenta los dobles (1,1), (2,2), etc.
Suma es 4 - Resultados donde la suma de ambos dados es 4
Suma es 7 u 11 - Resultados donde la suma es 7 u 11
Dado azul muestra 2 - Casos donde el dado azul es 2
Al menos uno muestra 2 - Al menos un dado muestra 2
Ninguno muestra 2 - Ningún dado muestra 2
Suma es par - Resultados con suma par
Cómo ejecutar
python main.py
Tecnologías
Python 3.x
